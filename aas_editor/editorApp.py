...
class EditorApp(QMainWindow, design.Ui_MainWindow):
    ...
    def initToolbars(self):
        ...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.packTreeView.undoAct)
        self.toolBar.addAction(self.packTreeView.redoAct)
        self.toolBar.addAction(self.packTreeView.editCreateInDialogAct)
