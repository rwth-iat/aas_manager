...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setBaseSize(QtCore.QSize(256, 25))
        ...
        self.aasItemsTreeView = QtWidgets.QTreeView(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.aasItemsTreeView.sizePolicy().hasHeightForWidth())
        self.aasItemsTreeView.setSizePolicy(sizePolicy)
        self.aasItemsTreeView.setSizeIncrement(QtCore.QSize(256, 493))
        self.aasItemsTreeView.setBaseSize(QtCore.QSize(256, 493))
        self.aasItemsTreeView.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.aasItemsTreeView.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.aasItemsTreeView.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.aasItemsTreeView.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.aasItemsTreeView.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.aasItemsTreeView.setObjectName("aasItemsTreeView")
        self.verticalLayout.addWidget(self.aasItemsTreeView)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Import asset shell"))
        self.label.setText(_translate("MainWindow", "Choose theme:"))
        self.comboBox.setCurrentText(_translate("MainWindow", "light"))
